    ...
    return `
        <section class="starship__Card noselect" id="${ id }">
            ...
            <div class="details hidden" id="${ id }a">
                ...
                <p class="starship__content"><span class="title">Hyperdrive Rating:</span> ${ numberWithCommas(starship.hyperdrive_rating) }</p>
                <p class="starship__content"><span class="title">Megalight Per Hour:</span> ${ numberWithCommas(starship.MGLT) } MGLT</p>
                <p class="starship__content"><span class="title">Max Atmosphering Speed:</span> ${ numberWithCommas(starship.max_atmosphering_speed) } km/h</p>
                ...
                <p class="starship__content"><span class="title">Cargo Capacity:</span> ${ numberWithCommas(starship.cargo_capacity) }</p>
            </div>
        </section>
    `
}
